...
Ce module teste les commandes login, logout, et whoami
telles que décrites dans la section "2. Démonstration - Authentification"
du guide de soutenance (docs/oc/SOUTENANCE.md).
...
class TestLoginCommand:
    ...
    def test_login_with_valid_credentials(self, mock_user, mock_token_file):
        """
        ...
        with patch("src.cli.commands.Container") as mock_container:
            ...
            # Mock Sentry
            with patch("src.sentry_config.set_user_context"):
...
class TestTokenStorage:
    ...
    def test_token_saved_to_file(self, mock_user, mock_token_file):
        """
        ...
        with patch("src.cli.commands.Container") as mock_container:
            ...
            mock_auth_service = MagicMock()
            mock_auth_service.authenticate.return_value = mock_user
            mock_auth_service.generate_token.return_value = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxfQ.fake_signature"
            mock_auth_service.TOKEN_FILE = mock_token_file
...
class TestWhoamiWithAuthentication:
    ...
    def test_whoami_with_authentication(self, mock_user):
        """
...
class TestLogoutCommand:
    ...
    def test_logout_deletes_token(self, mock_user, mock_token_file):
        """
        ...
        with patch("src.cli.commands.Container") as mock_container:
            ...
            # Mock Sentry
            with patch("src.sentry_config.clear_user_context"), \
                 patch("src.sentry_config.add_breadcrumb"):
                # Execute logout
...
class TestAuthenticationFlow:
    ...
    def test_complete_authentication_flow(self, mock_user, mock_token_file):
        """
        ...
        with patch("src.cli.commands.Container") as mock_container:
            ...
            # Mock Sentry
            with patch("src.sentry_config.set_user_context"), \
                 patch("src.sentry_config.clear_user_context"), \
                 patch("src.sentry_config.add_breadcrumb"):
